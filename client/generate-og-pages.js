...
const blogPosts = [
  { slug: 'how-to-register-a-drone-with-the-faa', ogTitle: 'How to Register a Drone with the FAA (2026)', ogDesc: 'FAA drone registration costs $5, takes five minutes on FAADroneZone, and lasts three years. Here\'s who has to register, the 250-gram rule, and how recreational and Part 107 registration differ.', image: 'https://faaexaminations.com/blog-part107-drone.jpg' },
  { slug: 'how-to-use-an-e6b-flight-computer', ogTitle: 'How to Use an E6B Flight Computer (Beginner\'s Guide)', ogDesc: 'The E6B looks intimidating but does a handful of jobs: time-speed-distance, fuel burn, true airspeed, density altitude, and wind correction. Here\'s what each side does and why it still matters on the FAA exam.', image: 'https://faaexaminations.com/blog-e6b-computer.jpg' },
  { slug: 'aircraft-right-of-way-rules', ogTitle: 'Aircraft Right-of-Way Rules Explained (FAR 91.113)', ogDesc: 'Who yields to whom in the air? The FAA right-of-way hierarchy under 14 CFR 91.113 — distress, the category pecking order, and the converging, head-on, and overtaking rules tested on the FAA exam.', image: 'https://faaexaminations.com/blog-pilots-flying.jpg' },
  { slug: 'special-use-airspace-explained', ogTitle: 'Special Use Airspace Explained: MOAs, Restricted, and Prohibited Areas', ogDesc: 'Special use airspace — MOAs, restricted, prohibited, warning, and alert areas — is separate from the Class A–G system. Here\'s what each means, whether you can fly through it, and how the exam tests it.', image: 'https://faaexaminations.com/blog-sectional-chart.jpg' },
  { slug: 'how-laanc-works', ogTitle: 'How LAANC Works: Instant Drone Airspace Authorization (2026)', ogDesc: 'LAANC gives drone pilots near-instant authorization to fly in controlled airspace under 400 feet. Here\'s how it works, which apps provide it, and how it applies to Part 107 and recreational flyers.', image: 'https://faaexaminations.com/blog-navigation.jpg' },
  { slug: 'faa-remote-id-rules', ogTitle: 'FAA Remote ID Rules: What Drone Pilots Must Do in 2026', ogDesc: 'Remote ID is now fully enforced. Every drone that needs FAA registration must comply one of three ways: a Standard Remote ID drone, a broadcast module, or flying in a FRIA. Here\'s how each works.', image: 'https://faaexaminations.com/blog-part107-drone.jpg' },
  { slug: 'part-107-recurrent-training', ogTitle: 'Part 107 Recurrent Training: How to Renew Your Drone Certificate (2026)', ogDesc: 'Part 107 no longer requires a recurrent test. Renew with the free online ALC-677 course on FAASafety.gov every 24 calendar months. Here\'s exactly how it works and what changed.', image: 'https://faaexaminations.com/blog-part107-drone.jpg' },
  { slug: 'what-to-bring-to-the-faa-written-exam', ogTitle: 'What to Bring to the FAA Written Exam (2026 Checklist)', ogDesc: 'ID, authorization, calculator and E6B rules for the FAA knowledge test — plus what gets you turned away at the door. A complete what-to-bring checklist for the PSI testing center.', image: 'https://faaexaminations.com/blog-faa-simulator.jpg' },
  { slug: 'how-long-is-the-faa-written-exam-good-for', ogTitle: 'How Long Is the FAA Written Exam Good For?', ogDesc: 'Your FAA knowledge test result is valid for 24 calendar months. Here\'s exactly when it expires, what the clock is for, and the timing mistake that makes pilots pay for it twice.', image: 'https://faaexaminations.com/blog-preflight.jpg' },
  { slug: 'how-much-does-the-faa-written-exam-cost', ogTitle: 'How Much Does the FAA Written Exam Cost? (2026)', ogDesc: 'The FAA knowledge test costs $175 — same for Private Pilot, Instrument, Commercial, and Part 107. Here\'s what the fee covers, what it doesn\'t, and the cost nobody budgets for: the retake.', image: 'https://faaexaminations.com/blog-student-pilot.jpg' },
