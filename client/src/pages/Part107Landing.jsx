    ...
    <div className="lp">
      ...
      <section style={{ padding: '90px 40px', background: 'var(--lp-charcoal)', borderTop: '1px solid var(--lp-border)' }} id="pricing">
        <div className="lp-section-inner" style={{ textAlign: 'center' }}>
          ...
          <p className="lp-section-sub" style={{ margin: '0 auto 52px' }}>One price. Lifetime access. Everything included.</p>
          <div className="fade-up" style={{ maxWidth: 440, margin: '0 auto', background: 'rgba(48,172,226,0.06)', border: '2px solid var(--lp-border2)', borderRadius: 20, padding: '48px 40px', position: 'relative' }}>
            ...
            <div style={{ color: 'var(--lp-text3)', fontSize: 14, marginBottom: 36 }}>one-time · lifetime access</div>
            ...
            <div style={{ marginTop: 16, fontSize: 13, color: 'var(--lp-text3)' }}>Try the free demo above · Pay once when you're ready</div>
          </div>
        </div>
      </section>
