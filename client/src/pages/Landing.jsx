      ...
      <section className="lp-hero">
        ...
        <div className="lp-hero-content">
          ...
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.75)', marginTop: 14, lineHeight: 2 }}>
            🔒 3 Days Free Before Credit Card Gets Charged
          </div>
          ...
          <div className="lp-products-grid fade-up">
            ...
            <div className="lp-product-card lp-featured lp-product-bundle">
              ...
              <div className="lp-product-body">
                ...
                <div className="lp-product-desc">2,826 questions across PAR, IRA, and CAX — one subscription, all three exams. The fastest path from student pilot to commercial certificate. <Link to="/bundle" style={{ color: 'var(--lp-blue)', textDecoration: 'none', fontWeight: 600, whiteSpace: 'nowrap' }}>Learn more →</Link></div>
                ...
                <div className="lp-product-price-sub"><Link to="/cancel-policy" style={{ color: 'inherit', textDecoration: 'underline', opacity: 0.75 }}>3-day free trial</Link> · Cancel anytime</div>
        ...
        <div className="lp-section-inner" style={{ textAlign: 'center' }}>
          ...
          <div className="lp-steps fade-up">
            <div className="lp-step">
              ...
              <img src="/plane-step1.webp" alt="Choose package" className="lp-step-img" loading="lazy" />
            </div>
            <div className="lp-step">
              ...
              <img src="/plane-step2.webp" alt="Study modules" className="lp-step-img" loading="lazy" />
            </div>
            <div className="lp-step">
              ...
              <img src="/plane-step3.webp" alt="Pass exam" className="lp-step-img" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
