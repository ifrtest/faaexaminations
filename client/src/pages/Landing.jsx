  ...
  return (
    <div className="lp">
      ...
      <footer className="lp-footer">
        ...
        <div style={{ marginTop: 12, display: 'flex', justifyContent: 'center', gap: 18, marginBottom: 6 }}>
          <a href="https://www.facebook.com/profile.php?id=61550998640330" target="_blank" rel="noopener noreferrer"
            style={{ color: 'var(--lp-text3)', opacity: 0.6, display: 'flex', alignItems: 'center' }}
        ...
        <div style={{ marginTop: 4, fontSize: '.75rem', color: 'var(--lp-text3)', opacity: 0.6 }}>
          Designed by <a href="https://websitework.ca" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--lp-text3)' }}>websitework.ca</a>
        </div>
        <div style={{ marginTop: 4, fontSize: '.75rem', color: 'var(--lp-text3)', opacity: 0.6, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
          Our Canadian Partner
          <img src="/maple-leaf.png" alt="🍁" style={{ width: 12, height: 12, display: 'inline-block', verticalAlign: 'middle' }} />
