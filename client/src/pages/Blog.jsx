...
const POSTS = [
  {
    slug: 'how-to-register-a-drone-with-the-faa',
    title: 'How to Register a Drone with the FAA (2026)',
    excerpt: "FAA drone registration costs $5, takes five minutes on FAADroneZone, and lasts three years. Here's who has to register, the 250-gram rule, and how recreational and Part 107 registration differ.",
    date: 'June 1, 2026',
    readTime: '4 min read',
    tag: 'Study Tips',
  ...
  {
    slug: 'how-to-use-an-e6b-flight-computer',
    title: 'How to Use an E6B Flight Computer (Beginner’s Guide)',
    excerpt: "The E6B looks intimidating but does a handful of jobs: time-speed-distance, fuel burn, true airspeed, density altitude, and wind correction. Here's what each side does and why it still matters on the FAA exam.",
    date: 'June 1, 2026',
    readTime: '5 min read',
    tag: 'Study Tips',
  ...
  {
    slug: 'aircraft-right-of-way-rules',
    title: 'Aircraft Right-of-Way Rules Explained (FAR 91.113)',
    excerpt: "Who yields to whom in the air? The FAA right-of-way hierarchy under 14 CFR 91.113 — distress, the category pecking order, and the converging, head-on, and overtaking rules tested on the FAA exam.",
    date: 'June 1, 2026',
    readTime: '4 min read',
    tag: 'Private Pilot',
  ...
  {
    slug: 'special-use-airspace-explained',
    title: 'Special Use Airspace Explained: MOAs, Restricted, and Prohibited Areas',
    excerpt: "Special use airspace — MOAs, restricted, prohibited, warning, and alert areas — is separate from the Class A–G system. Here's what each means, whether you can fly through it, and how the exam tests it.",
    date: 'June 1, 2026',
    readTime: '5 min read',
    tag: 'Private Pilot',
  ...
  {
    slug: 'how-laanc-works',
    title: 'How LAANC Works: Instant Drone Airspace Authorization (2026)',
    excerpt: "LAANC gives drone pilots near-instant authorization to fly in controlled airspace under 400 feet. Here's how it works, which apps provide it, and how it applies to Part 107 and recreational flyers.",
    date: 'June 1, 2026',
    readTime: '4 min read',
    tag: 'Study Tips',
