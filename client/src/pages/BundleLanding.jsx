      ...
      <section className="lp-hero lp-hero-bundle" style={{ backgroundImage: 'url(/plane-bundle.jpg)', backgroundSize: 'cover', backgroundPosition: 'center 35%' }}>
        ...
        <div className="lp-hero-split">
          ...
          <div className="lp-hero-pricing-card">
            ...
            <Link to="/exams?buy=bundle" style={{ display: 'block', textAlign: 'center', marginTop: 10, padding: '13px 28px', borderRadius: 10, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.18)', color: '#fff', fontWeight: 700, fontSize: 15, textDecoration: 'none' }}>Subscribe Now — $39.99/mo →</Link>
      ...
      <section style={{ padding: '90px 40px', background: 'var(--lp-charcoal)', borderTop: '1px solid var(--lp-border)' }} id="pricing" className="lp-pricing-section">
        <div className="lp-section-inner" style={{ textAlign: 'center' }}>
          ...
          <div className="fade-up" style={{ maxWidth: 440, margin: '0 auto', background: 'rgba(48,172,226,0.06)', border: '2px solid var(--lp-border2)', borderRadius: 20, padding: '48px 40px', position: 'relative' }}>
            ...
            <Link to="/register" className="lp-btn-hero" style={{ display: 'block', textAlign: 'center', fontSize: 18, padding: '18px 40px' }}>Start Free — 10 Questions Now →</Link>
            <Link to="/exams?buy=bundle" style={{ display: 'block', textAlign: 'center', marginTop: 12, padding: '15px 40px', borderRadius: 10, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.18)', color: '#fff', fontWeight: 700, fontSize: 16, textDecoration: 'none' }}>Subscribe Now — $39.99/mo →</Link>
