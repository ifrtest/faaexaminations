...
const FAQS = [
  {
    ...
    a: 'Everything. Private Pilot (PAR), Instrument Rating (IRA), Commercial Pilot (CAX), and Part 107 Remote Pilot — all in one subscription. 3,000+ practice questions, all study modules, and AI instructor support across all four exams.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Individual packages are $24.99/month each. The bundle gives you all four for $69.99/month — saving you $30/month compared to buying PAR + IRA + CAX + Part 107 individually.',
  },
  {
  ...
  {
    q: 'What if I only need one or two exams right now?',
    a: 'If you\'re only focused on one exam right now, an individual package at $24.99/month is the better value. The bundle makes sense if you\'re working toward multiple certificates or want everything available.',
  },
];
...
export default function BundleLanding() {
  ...
  return (
    <div className="lp">
      <Helmet>
        <title>FAA Pilot Bundle — PAR, IRA, CAX & Part 107 | FAAExaminations.com</title>
        <meta name="description" content="Get all four FAA knowledge test prep packages in one bundle. Private Pilot, Instrument Rating, Commercial Pilot, and Part 107. 3,000+ questions. $69.99/month." />
      ...
      <section className="lp-hero" style={{ backgroundImage: 'url(/plane-bundle.webp)', backgroundSize: 'cover', backgroundPosition: 'center center' }}>
        ...
        <div className="lp-hero-content">
          <div className="lp-hero-badge">
            ...
            FULL PILOT BUNDLE · ALL 4 FAA EXAMS · 2026
          </div>
          <h1>Every FAA Written.<br /><span className="lp-accent">One Subscription.</span></h1>
          <p className="lp-hero-sub">
            PAR, IRA, CAX, and Part 107 — all in one place. 3,000+ practice questions, AI instructor support, and timed simulators for every exam on your path to commercial aviation.
          </p>
          ...
          <div style={{ fontSize: 13, color: 'var(--lp-text3)', marginTop: 14, opacity: 0.8, lineHeight: 2 }}>
            ...
            Full bundle access from $69.99/month · Cancel anytime
          </div>
          <div className="lp-hero-stats">
            <div><div className="lp-hs-val">3,000+</div><div className="lp-hs-lbl">Total Questions</div></div>
            <div><div className="lp-hs-val">4</div><div className="lp-hs-lbl">FAA Exams Covered</div></div>
            <div><div className="lp-hs-val">AI</div><div className="lp-hs-lbl">Instructor Included</div></div>
            <div><div className="lp-hs-val">$30</div><div className="lp-hs-lbl">Saved vs Individual</div></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '90px 40px', background: 'var(--lp-charcoal)' }} id="includes">
        <div className="lp-section-inner">
          ...
          <h2>All Four FAA Packages in One</h2>
          <p className="lp-section-sub">Every exam on your path from student pilot to commercial certificate — fully covered.</p>
          ...
          <div className="fade-up" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 24, marginTop: 52 }}>
            {[
              ...
              { icon: '🚁', badge: '107', title: 'Part 107 Remote Pilot', questions: 'Drone-specific questions', desc: 'Get licensed to fly commercially. Airspace, weather, and drone regulations — everything for Part 107.', url: '/part-107' },
            ].map((pkg, i) => (
        ...
        <div className="lp-section-inner" style={{ textAlign: 'center' }}>
          ...
          <div className="fade-up" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, marginTop: 52, maxWidth: 800, margin: '52px auto 0' }}>
            ...
            <div style={{ background: 'rgba(48,172,226,0.04)', border: '1px solid var(--lp-border)', borderRadius: 20, padding: '40px 32px', textAlign: 'center' }}>
              ...
              <div style={{ color: 'var(--lp-text3)', fontSize: 14, marginBottom: 24 }}>All 4 = $99.96/month</div>
            ...
            <div style={{ background: 'rgba(48,172,226,0.08)', border: '2px solid var(--lp-border2)', borderRadius: 20, padding: '40px 32px', textAlign: 'center', position: 'relative' }}>
              <div style={{ position: 'absolute', top: -16, left: '50%', transform: 'translateX(-50%)', background: 'var(--lp-blue)', color: '#fff', padding: '6px 20px', borderRadius: 20, fontSize: 12, fontWeight: 700, fontFamily: 'Share Tech Mono, monospace', letterSpacing: 1, whiteSpace: 'nowrap' }}>BEST VALUE — SAVE $30/MONTH</div>
              <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 18, fontWeight: 700, color: '#fff', marginBottom: 8 }}>Full Bundle</div>
              <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: 64, fontWeight: 900, color: '#fff', lineHeight: 1 }}>$69.99</div>
              <div style={{ color: 'var(--lp-text3)', fontSize: 14, marginBottom: 24 }}>all 4 exams / per month</div>
              <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 32px', textAlign: 'left' }}>
                {['PAR + IRA + CAX + Part 107', '3,000+ practice questions', 'AI instructor for all exams', 'All timed simulators', 'All FAA references', 'Cancel anytime'].map((item, i) => (
      ...
      <section style={{ padding: '90px 40px', background: 'rgba(5,88,102,0.15)', borderTop: '1px solid var(--lp-border)', textAlign: 'center' }}>
        <div className="lp-section-inner">
          ...
          <p style={{ color: 'var(--lp-text2)', fontSize: 18, maxWidth: 520, margin: '0 auto 40px', lineHeight: 1.7 }}>
            PAR, IRA, CAX, and Part 107. Start free today — no credit card needed.
          </p>
