      ...
      <section className="lp-hero lp-hero-ira" style={{ backgroundImage: 'url(/plane-ira.webp)', backgroundSize: 'cover', backgroundPosition: 'center 40%' }}>
        ...
        <div className="lp-hero-split">
          ...
          <div className="lp-hero-pricing-card">
            ...
            <Link to="/exams?buy=ira" style={{ display: 'block', textAlign: 'center', marginTop: 10, padding: '13px 28px', borderRadius: 10, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.18)', color: '#fff', fontWeight: 700, fontSize: 15, textDecoration: 'none' }}>Subscribe Now — $24.99/mo →</Link>
      ...
      <section style={{ padding: '90px 40px', background: 'rgba(5,88,102,0.10)', borderTop: '1px solid var(--lp-border)', borderBottom: '1px solid var(--lp-border)' }} id="pricing" className="lp-pricing-section">
        <div className="lp-section-inner" style={{ textAlign: 'center' }}>
          ...
          <div className="fade-up" style={{ maxWidth: 440, margin: '0 auto', background: 'rgba(48,172,226,0.06)', border: '2px solid var(--lp-border2)', borderRadius: 20, padding: '48px 40px', position: 'relative' }}>
            ...
            <Link to="/exams?buy=ira" style={{ display: 'block', textAlign: 'center', marginTop: 12, padding: '15px 40px', borderRadius: 10, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.18)', color: '#fff', fontWeight: 700, fontSize: 16, textDecoration: 'none' }}>Subscribe Now — $24.99/mo →</Link>
      ...
      <section style={{ padding: '90px 40px', background: 'var(--lp-dark)', borderTop: '1px solid var(--lp-border)' }}>
        <div className="lp-section-inner">
          ...
          <div style={{ textAlign: 'center', marginTop: 48 }}>
            <Link to="/register" className="lp-btn-hero" style={{ fontSize: 17, padding: '16px 40px' }}>Start Studying Free Today →</Link>
          </div>
        </div>
      </section>
