...
const FAQS = [
  {
    ...
    a: '65 questions (60 scored + 5 unscored validation questions), with a 2-hour time limit. You need a score of 70% or higher to pass. The IRA is widely considered the most challenging FAA written exam — our 821-question bank covers every topic the FAA tests.',
  },
  {
        ...
        <div className="lp-section-inner">
          ...
          <div className="fade-up" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, marginTop: 52 }}>
            {[
              ...
              { svg: <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#30ace2" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, title: 'Timed Exam Simulator', desc: "Simulate the real 2-hour, 65-question FAA test. Track your score by topic and keep drilling your weak areas until you're consistently above 80%." },
